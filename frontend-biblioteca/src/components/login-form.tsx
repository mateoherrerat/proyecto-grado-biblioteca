        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <div className="text-center text-xs text-muted-foreground">
              ...
              <Link href={`/registro${searchParams.toString() ? `?${searchParams.toString()}` : ''}`} className="underline underline-offset-4 font-bold text-primary hover:text-primary/80">
                Registrarse
              </Link>
            </div>
          </div>
          ...
          {accion === "solicitar" && (
            <div className="p-3 rounded-xl bg-primary/10 border border-primary/20 text-primary text-xs font-bold text-center">
              Inicia sesión o regístrate para solicitar el préstamo de "{tituloLibro}".
            </div>
          )}
